...
@endphp
<div id="shop_pos_item_{{ $dish->id }}">

    <div class="modal-title d-flex d-md-none">
        <div class="h2 mb-4 flex-grow-1 title">
            {{ $dish->name }}
        </div>
    ...
    <div class="row">
        <div class="col-lg-6">
            ...
            <div class="h2" id="shop_pos_item_title_{{ $dish->id }}">
                <span class="pr-2 d-md-inline-block d-none">{{ $dish->name }}</span>
                <span class="badge text-success bg-transparent pl-0"><span class="variants_shortname_holder">{{ $description }}</span></span>
            </div>
            ...
            @if($dish->variants->count())
                <div id="dish_{{$dish->id}}_variants" class="variants dish_variants_groups" data-id="{{$dish->id}}" data-price="{{ $dish->new_price ? $dish->new_price : $dish->price }}" data-weight="{{ $dish->weight }}">
            ...
            <div class="price d-flex justify-content-between">
                <div class="h1 mb-0">
                    @if($dish->new_price)
                        ...
                        <span class="new"><span class="variants_price_holder">{{ $dish->new_price }}</span> &#8381;</span>
                    @else
                        <span class="variants_price_holder">{{ $dish->price }}</span> &#8381;
                    @endif
                </div>
                <div>
        ...
        <div class="col-lg-6 border-left dops mt-3 mt-lg-0">
            ...
            @if(count($dishes_viewed))
                <div class="past mt-2 pt-1 pb-2 pb-sm-0">
